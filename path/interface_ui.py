...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.temp.sizePolicy().hasHeightForWidth())
        self.temp.setSizePolicy(sizePolicy1)
        ...
        sizePolicy4.setHeightForWidth(self.windIco.sizePolicy().hasHeightForWidth())
        self.windIco.setSizePolicy(sizePolicy4)
        ...
        self.windText.setFont(font3)

        self.horizontalLayout_4.addWidget(self.windText)

        self.humIco = QLabel(self.frame)
        self.humIco.setObjectName(u"humIco")
        sizePolicy4.setHeightForWidth(self.humIco.sizePolicy().hasHeightForWidth())
        self.humIco.setSizePolicy(sizePolicy4)
        ...
        self.humText.setFont(font3)

        self.horizontalLayout_4.addWidget(self.humText)

        self.pressIco = QLabel(self.frame)
        self.pressIco.setObjectName(u"pressIco")
        sizePolicy4.setHeightForWidth(self.pressIco.sizePolicy().hasHeightForWidth())
        self.pressIco.setSizePolicy(sizePolicy4)
        ...
        self.prognoz14.setSizePolicy(sizePolicy3)
        palette6 = QPalette()
        self.prognoz14.setPalette(palette6)
        self.prognoz14.setFont(font6)
